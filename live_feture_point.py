...
class feture_point():
    def __init__(self,img_1,img_2):
        ...
        keypoint_1,decriptor_1 = sift.detectAndCompute(img1,None)
        keypoint_2,decriptor_2 = sift.detectAndCompute(img2,None)

        match = bf.match(decriptor_1,decriptor_2)
        match = sorted(match,key = lambda x:x.distance)
        
        img3 = cv2.drawMatches(img1,keypoint_1,img2,keypoint_2,match[:100],img2,flags=2)
...
if __name__ == "__main__":
    ...
    # plt.show()
    # feture = feture_point("D://computer_vision//tsukuba_l.png","D://computer_vision//tsukuba_r.png")
    s = feture_point_v()
